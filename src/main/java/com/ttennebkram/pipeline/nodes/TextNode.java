 ...
 */
@NodeInfo(name = "Text", category = "Content", aliases = {})
public class TextNode extends ProcessingNode {
    ...
    public void deserializeProperties(JsonObject json) {
        ...
        if (json.has("fontIndex")) fontIndex = json.get("fontIndex").getAsInt();
        if (json.has("fontScale")) fontScale = json.get("fontScale").getAsDouble();
        ...
        if (json.has("italic")) italic = json.get("italic").getAsBoolean();
    }
}
