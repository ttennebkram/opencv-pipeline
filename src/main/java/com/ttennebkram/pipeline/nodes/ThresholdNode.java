...
public class ThresholdNode extends ProcessingNode {
    ...
    public void serializeProperties(JsonObject json) {
        ...
        json.addProperty("modifierIndex", modifierIndex);
        json.addProperty("returnedThreshold", returnedThreshold);
    }
    ...
    public void deserializeProperties(JsonObject json) {
        ...
        if (json.has("modifierIndex")) {
            modifierIndex = json.get("modifierIndex").getAsInt();
        }
        if (json.has("returnedThreshold")) {
            returnedThreshold = json.get("returnedThreshold").getAsDouble();
        }
    }
}
