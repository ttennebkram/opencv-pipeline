...
public class FFTLowPass4Node extends MultiOutputNode {
    ...
    private Mat createSpectrumVisualization(Mat dftShift, int origRows, int origCols) {
        ...
        if (radius > 0) {
            ...
            System.out.println("[FFTLowPass4] Drawing red circle: center=(" + centerX + "," + centerY + "), radius=" + radius + ", imgSize=" + spectrumBGR.cols() + "x" + spectrumBGR.rows());
    ...
    private Mat createFilterCurveVisualization(int width, int height) {
        ...
        System.out.println("[FFTLowPass4] Drawing filter curve: graphWidth=" + graphWidth + ", graphHeight=" + graphHeight + ", radius=" + radius);
