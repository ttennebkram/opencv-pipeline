...
/**
 * Subtract with Clamping node - subtracts second image from first with clamping to 0-255.
 * Has two input connection points for receiving images from two sources.
 */
@NodeInfo(name = "SubtractClamp", category = "Dual Input", aliases = {"Subtract Clamp"})
public class SubtractClampNode extends DualInputNode {
    ...
    public void paint(GC gc) {
        ...
        Color helpBgColor = enabled ? new Color(255, 230, 200) : new Color(DISABLED_BG_R, DISABLED_BG_G, DISABLED_BG_B);
    ...
    public String getDescription() {
        return "Subtract Images with Clamping\ncv2.subtract(img1, img2)";
    }

    @Override
    public String getDisplayName() {
        return "Subtract w/Clamp";
    }
