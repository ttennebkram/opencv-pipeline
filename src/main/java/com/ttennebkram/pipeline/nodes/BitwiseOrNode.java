...
/**
 * Bitwise OR node - performs bitwise OR on two images.
 * Has two input connection points for receiving images from two sources.
 */
@NodeInfo(name = "BitwiseOr", category = "Dual Input", aliases = {"Bitwise Or"})
public class BitwiseOrNode extends DualInputNode {
    public BitwiseOrNode(Display display, Shell shell, int x, int y) {
        super(display, shell, "Bitwise OR", x, y);
    }
    ...
    public void showPropertiesDialog() {
        ...
        dialog.setText("Bitwise OR Properties");
