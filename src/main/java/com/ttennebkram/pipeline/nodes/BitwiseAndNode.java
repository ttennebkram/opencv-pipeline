...
/**
 * Bitwise AND node - performs bitwise AND on two images.
 * Has two input connection points for receiving images from two sources.
 */
@NodeInfo(name = "BitwiseAnd", category = "Dual Input", aliases = {"Bitwise And"})
public class BitwiseAndNode extends DualInputNode {
    public BitwiseAndNode(Display display, Shell shell, int x, int y) {
        super(display, shell, "Bitwise AND", x, y);
    }
    ...
    public void paint(GC gc) {
        ...
        Color bgColor = enabled ? new Color(200, 230, 255) : new Color(DISABLED_BG_R, DISABLED_BG_G, DISABLED_BG_B);
    ...
    public void showPropertiesDialog() {
        ...
        dialog.setText("Bitwise AND Properties");
